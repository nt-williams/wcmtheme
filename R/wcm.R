wcm <- function(...) {
  ...
  css <- system.file("rmarkdown", "templates", "wcm", "resources", "styles.css", package = "wcmtheme")
  header <- system.file("rmarkdown", "templates", "wcm", "resources", "header.html", package = "wcmtheme")
  footer <- system.file("rmarkdown", "templates", "wcm", "resources", "footer.html", package = "wcmtheme")
...
#' @export
wcm <- function(number_sections = FALSE,
                fig_width = 7,
                fig_height = 5,
  ...
  dep <- htmltools::htmlDependency(
    name = "wcm",
    version = "0.1.0",
    system.file("rmarkdown", "templates", "wcm", "resources", package = "wcm"),
  ...
  args <- c(
    ...
    rmarkdown::pandoc_path_arg(
      system.file("rmarkdown", "templates", "wcm", "base.html", package = "wcm")
    )
  )
